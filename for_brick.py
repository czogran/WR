#by zdekomponowac problem- pierwszy to byl obrot na skrzyzowaniu z czerwona, teraz bedzie podjazd po klocek, podniesienie go
#obrocenie sie i powrot i skret na czarnej
...
#czy na pewno dobre wejscie
infrared=InfraredSensor('in3')
...
while not touch_sensor.is_pressed:
    ...
    poprzedni_blad = blad
    #zatrzymuje sie jak zobaczy klocek
...
medium.run_timed(time_sp=200, speed_sp=-200)
right_engine.run_timed(time_sp=1500, speed_sp=-200)
left_engine.run_timed(time_sp=1500, speed_sp=-200)
medium.run_timed(time_sp=200, speed_sp=200, stop_action = "break")
